...
server.on('error', (err) => {
  if (err.code === 'EADDRINUSE') {
    ...
    console.error('\n🔧 Solutions:');
    console.error('   1. Stop the process using the port:');
    ...
    console.error('      - Linux/Mac: PORT=3001 node server.js');
    console.error('   3. Or modify the port directly in the code\n');
    process.exit(1);
  } else {
