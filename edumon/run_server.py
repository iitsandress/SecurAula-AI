...
def main():
    ...
    print("\n🚀 Iniciando servidor...")
    print("📊 Dashboard disponible en: http://190.84.119.196:8000/dashboard")
    print("🔧 API disponible en: http://190.84.119.196:8000/docs")
    print("❤️  Health check: http://190.84.119.196:8000/health")
